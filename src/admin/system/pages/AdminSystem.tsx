...
export default function AdminSystem() {
  ...
  return (
    <main className='p-6 lg:p-8 max-w-[1100px] mx-auto'>
      ...
      <div className={`bg-white border rounded-xl px-5 py-4 flex items-center gap-4 mb-6 ${
        ...
        <div className='ml-auto text-[10px] text-muted/50 font-mono'>
      ...
      <div className='mt-8 bg-white border border-ink/[0.08] rounded-xl p-5'>
        ...
        <div className='grid grid-cols-2 lg:grid-cols-4 gap-4'>
          {[
            ...
            <div key={label}>
              <div className='text-[10px] font-bold text-muted/70 mb-1'>{label}</div>
              <div className='text-[10px] text-muted/50 font-mono'>{desc}</div>
            </div>
          ))}
        </div>
      </div>
